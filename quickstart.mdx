---
title: "Quickstart: Run the MLB Performance Analytics Pipeline"
sidebarTitle: "Quickstart"
description: "Set up your Python environment and run the MLB Performance Analytics notebook to classify MLB batters using Random Forest models in under 10 minutes."
---
...
Each target gets its own `RandomForestClassifier` trained on an 80/20 train/test split (stratified for the elite and discipline models):

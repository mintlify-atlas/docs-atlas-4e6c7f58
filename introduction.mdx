---
title: "MLB Performance Analytics: Classifying Batters by ML"
sidebarTitle: "Introduction"
description: "How MLB Performance Analytics uses Random Forest classifiers on Statcast data to classify 911 MLB batters across three offensive performance dimensions."
---
...
<CardGroup cols={3}>
  <Card title="Overall Offensive Performance" icon="chart-bar" href="/models/target-variables">
  ...
  <Card title="Elite Status" icon="trophy" href="/results/elite-classification">
  ...
  <Card title="Plate Discipline" icon="eye" href="/results/plate-discipline">
